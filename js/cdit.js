...
var teamChartFiles = {};
var teamTableFiles = {};
var chartSlideTempl = '<div data-slidr=\"PROJECT_ID\" style=\"border-style: solid; border-width: 1px; border-color: #e1e1e1;\"><div style=\"padding: 10px; text-align: center;\"><h2>PROJECT_ID</h2></div><div id=\"PROJECT_ID-agile\" style=\"float: left; width: 410px; height: 450px; margin: 0 auto\"></div><div id=\"PROJECT_ID-continuous-delivery\" style=\"float: left; width: 450px; height: 450px; margin: 0 auto\"></div></div>';
var tableSlideTempl = '<div data-slidr=\"PROJECT_ID-T\" style=\"border-style: solid; border-width: 1px; border-color: #e1e1e1; width: 860px;\"><div style=\"padding: 10px; text-align: center;\"><h2>PROJECT_ID</h2></div><div id=\"PROJECT_ID-agile-TH\" style=\"float: left; text-align: center; width: 400px; height: 40px; margin: auto;\"><h4>Agile</h4></div><div id=\"PROJECT_ID-cd-TH\" style=\"float: left; text-align: center; width: 400px; height: 40px; margin: auto;\"><h4>Continuous Delivery</h4></div><div id=\"PROJECT_ID-agile-T\" style=\"float: left; width: 400px; height: 410px; margin: auto;\"></div><div id=\"PROJECT_ID-cd-T\" style=\"float: left; width: 400px; height: 410px; margin: auto;\"></div></div>';
